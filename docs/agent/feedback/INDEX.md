...
| `2026-08-21-mvp-playable-review-handoff.md` | 15스테이지 플레이어블 MVP의 최신 QA·UX·레벨·코드 리뷰와 Landmine·스킬·OMX 활용 결과를 팀 검토용으로 정리했다. | proposed | commit `74315cc`, `docs/demo/MVP_DEMO_RUNBOOK.md` |
