...
export const ORIGINS: Record<OriginId, OriginData> = {
  SWORDSMAN: {
    ...
    icon: '⚔️',
    symbolBiasText: '소드/단검 물리 공격 심볼 가중치 우세 (안정적 딜링)',
  },
  GAMBLER: {
    id: 'GAMBLER',
    name: '빚진 도박사',
    ...
    narrative: '지하 도박장에서 마지막 칩 대신 저주받은 캐비닛의 레버를 당겼다. 리스크는 크지만 시작 시 풍부한 골드를 보유하여 암시장을 빠르게 이용할 수 있습니다.',
    startingGoldBonus: 50,
    startingHpBonus: -15,
    startingShieldBonus: 0,
    icon: '🎲',
    symbolBiasText: '골드/배율(CRIT) 심볼 가중치 우세 (하이리스크·상점 특화)',
  },
  PRIEST: {
    id: 'PRIEST',
    name: '파문당한 사제',
    ...
    startingHpBonus: 25,
    startingShieldBonus: 10,
    icon: '🔮',
    symbolBiasText: '방패/하트 회복 심볼 가중치 우세 (생존 및 특수 효과)',
  },
};
